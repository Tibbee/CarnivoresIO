...
classes = (
    ...
    animation.CARNIVORES_PG_rig_proposal_edge,
    animation.CARNIVORES_UL_rig_proposal_edges,
    animation.CARNIVORES_OT_analyze_rig_proposal,
    animation.CARNIVORES_OT_apply_rig_proposal,
    animation.CARNIVORES_OT_clear_rig_preview,
    animation.CARNIVORES_OT_validate_rig_round_trip,
    animation.CARNIVORES_OT_reconstruct_armature,
    animation.CARNIVORES_OT_cleanup_skipped_groups,
